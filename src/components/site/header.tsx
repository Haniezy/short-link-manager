...
export function SiteHeader({ locale, email, name, image, dashboard = false }: { locale: Locale; email: string | null; name?: string | null; image?: string | null; dashboard?: boolean }) {
  const t = copy[locale];
  return <header className="site-header"><div className="header-inner">
    ...
    <div className="header-actions"><DisplayControls locale={locale} /><HeaderAccount locale={locale} email={email} name={name} image={image} /></div>
  </div></header>;
}
